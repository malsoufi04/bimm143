...
> **N.M.** We never run an `install.packages()` in a code chunk
...
Read some data on the effects of GLP-1 inhibitor (drug) on gener
expression values:
...
I want to see a plot for each continent - in ggplot lingo this is call
“faceting”
